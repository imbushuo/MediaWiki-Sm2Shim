 ...
 *
 */
__awaiter=this&&this.__awaiter||function(n,t,i,r){return new(i||(i=Promise))(function(u,f){function o(n){try{e(r.next(n))}catch(t){f(t)}}function s(n){try{e(r["throw"](n))}catch(t){f(t)}}function e(n){n.done?u(n.value):new i(function(t){t(n.value)}).then(o,s)}e((r=r.apply(n,t||[])).next())})};__generator=this&&this.__generator||function(n,t){function e(n){return function(t){return o([n,t])}}function o(e){if(f)throw new TypeError("Generator is already executing.");while(r)try{if(f=1,u&&(i=u[e[0]&2?"return":e[0]?"throw":"next"])&&!(i=i.call(u,e[1])).done)return i;(u=0,i)&&(e=[0,i.value]);switch(e[0]){case 0:case 1:i=e;break;case 4:return r.label++,{value:e[1],done:!1};case 5:r.label++;u=e[1];e=[0];continue;case 7:e=r.ops.pop();r.trys.pop();continue;default:if(!(i=r.trys,i=i.length>0&&i[i.length-1])&&(e[0]===6||e[0]===2)){r=0;continue}if(e[0]===3&&(!i||e[1]>i[0]&&e[1]<i[3])){r.label=e[1];break}if(e[0]===6&&r.label<i[1]){r.label=i[1];i=e;break}if(i&&r.label<i[2]){r.label=i[2];r.ops.push(e);break}i[2]&&r.ops.pop();r.trys.pop();continue}e=t.call(n,r)}catch(o){e=[6,o];u=0}finally{f=i=0}if(e[0]&5)throw e[1];return{value:e[0]?e[1]:void 0,done:!0}}var r={label:0,sent:function(){if(i[0]&1)throw i[1];return i[1]},trys:[],ops:[]},f,u,i;return{next:e(0),"throw":e(1),"return":e(2)}},function(n){var t;(function(t){var i=Sm2ShimUtils.CssUtils,r=Sm2ShimUtils.DomUtils,u=Sm2ShimUtils.EventUtils,f=Sm2ShimUtils.PositionUtils,o=Sm2ShimUtils.StyleUtils,e=System.ArgumentNullException,s=function(){function s(f){var e=this,o,h;this.css={disabled:"disabled",selected:"selected",active:"active",legacy:"legacy",noVolume:"no-volume",playlistOpen:"playlist-open",lyricHighlight:"lyric-content-current",lyricHidden:"sm2-lyric-container-hidden",lyricContainerHidden:"sm2-lyric-wrapper-hidden"};this.extras={loadFailedCharacter:'<span title="Failed to load/play." class="load-error">✖<\/span>'};this.playerOptions={stopOtherSounds:!0,excludeClass:"sm2-exclude"};this.failureCount=0;this.failureThreshold=5;this.dom={o:null,playlist:null,playlistTarget:null,playlistContainer:null,time:null,player:null,progress:null,progressTrack:null,progressBar:null,duration:null,volume:null,lyricsContainer:null,lyricsWrapper:null,lyricsDrawer:null};this.self=this;this.actionData={volume:{x:0,y:0,width:0,height:0,backgroundSize:0}};this.actions={play:function(t){var u,i,r;if(t!==undefined&&!isNaN(t))return this.self.playlistController.playItemByOffset(t);r=t;r&&r.target&&(u=r.target||r.srcElement,i=u.getAttribute(n.Options.FileSrcAttribute));i&&i.indexOf("#")===-1||(i=this.self.dom.playlist.getElementsByTagName("a")[0].getAttribute(n.Options.FileSrcAttribute));this.self.soundObject||(this.self.soundObject=this.self.makeSound(i));this.self.soundObject.playState||this.self.stopOtherSounds();this.self.soundObject.togglePause();this.self.soundObject.paused&&this.self.playlistController.data.timer&&(window.clearTimeout(this.self.playlistController.data.timer),this.self.playlistController.data.timer=null)},pause:function(){e.self.soundObject&&e.self.soundObject.readyState&&e.self.soundObject.pause()},resume:function(){e.self.soundObject&&e.self.soundObject.readyState&&e.self.soundObject.resume()},stop:function(){return e.actions.pause()},next:function(){var n,t;e.playlistController.data.timer&&(window.clearTimeout(e.playlistController.data.timer),e.playlistController.data.timer=null);t=e.playlistController.data.selectedIndex;n=e.playlistController.getNext();n&&e.playlistController.data.selectedIndex!==t&&e.playLink(n.getElementsByTagName("a")[0])},prev:function(){var n,t;t=e.playlistController.data.selectedIndex;n=e.playlistController.getPrevious();n&&e.playlistController.data.selectedIndex!==t&&e.playLink(n.getElementsByTagName("a")[0])},repeat:function(n){var t=n?n.target||n.srcElement:r.get(e.dom.o,".repeat");t&&!i.hasClass(t,e.css.disabled)&&(i.toggleClass(t.parentNode,e.css.active),e.playlistController.data.loopMode=!e.playlistController.data.loopMode)},menu:function(n){var t;t=i.hasClass(e.dom.o,e.css.playlistOpen);!e.playlistController||e.playlistController.data.selectedIndex||e.firstOpen||(e.dom.playlist.scrollTop=0,e.firstOpen=!0);typeof n=="boolean"&&n||(t||(e.dom.playlistContainer.style.height="0px"),t=i.toggleClass(e.dom.o,e.css.playlistOpen));e.dom.playlistContainer.style.height=(t?e.dom.playlistContainer.scrollHeight:0)+"px"},adjustVolume:function(n){var t,i,f,r,e;return(f=this.dom.volume,n===undefined)?!1:!n||n.clientX===undefined?(arguments.length&&window.console&&window.console.warn&&console.warn("Bar UI: call setVolume("+n+") instead of adjustVolume("+n+")."),this.actions.setVolume.apply(this,arguments)):(t=(100-this.actionData.volume.backgroundSize)/2,e=Math.max(0,Math.min(1,(n.clientX-this.actionData.volume.x)/this.actionData.volume.width)),f.style.clip="rect(0px, "+this.actionData.volume.width*e+"px, "+this.actionData.volume.height+"px, "+this.actionData.volume.width*(t/100)+"px)",i=t/100*this.actionData.volume.width,r=Math.max(0,Math.min(1,(n.clientX-this.actionData.volume.x-i)/(this.actionData.volume.width-i*2)))*100,this.soundObject&&this.soundObject.setVolume(r),this.defaultVolume=r,u.preventDefault(n))},releaseVolume:function(){u.remove(document,"mousemove",this.actions.adjustVolume);u.remove(document,"mouseup",this.actions.releaseVolume)},setVolume:function(n){var r,u,t,f,i,e;n===undefined||isNaN(n)||(this.dom.volume&&(f=this.dom.volume,r=this.actionData.volume.backgroundSize,u=(100-r)/2,t=this.actionData.volume.width*(u/100),i=t,e=i+(this.actionData.volume.width-t*2)*(n/100),f.style.clip="rect(0px, "+e+"px, "+this.actionData.volume.height+"px, "+i+"px)"),this.soundObject&&this.soundObject.setVolume(n),this.defaultVolume=n)},self:this};this.playerNode=f;this.defaultVolume=soundManager.defaultOptions.volume;window.sm2BarPlayerOptions=this.playerOptions;this.playerNode||console.warn("Sm2Player.constructor(): No playerNode element?");this.dom.o=f;window.navigator.userAgent.match(/msie [678]/i)&&i.addClass(this.dom.o,this.css.legacy);window.navigator.userAgent.match(/mobile/i)&&i.addClass(this.dom.o,this.css.noVolume);this.dom.progress=r.get(this.dom.o,".sm2-progress-ball");this.dom.progressTrack=r.get(this.dom.o,".sm2-progress-track");this.dom.progressBar=r.get(this.dom.o,".sm2-progress-bar");this.dom.volume=r.get(this.dom.o,"a.sm2-volume-control");this.dom.lyricsContainer=r.get(this.dom.o,".sm2-lyric-bd");this.dom.lyricsWrapper=r.get(this.dom.o,".sm2-lyric-wrapper");this.dom.lyricsDrawer=r.get(this.dom.o,".sm2-lyric-drawer");this.resetLyrics();this.dom.duration=r.get(this.dom.o,".sm2-inline-duration");this.dom.time=r.get(this.dom.o,".sm2-inline-time");this.playlistController=new t.Sm2PlaylistController(this,this.dom,this.css);o=this.playlistController.getItem(0);this.playlistController.select(o);this.isGrabbing=!1;o&&(this.setTitle(o),h=o.getElementsByTagName("a")[0],this.currentFileUrl=h.getAttribute(n.Options.FileSrcAttribute),this.loadLyrics(h));u.add(this.dom.o,"mousedown",function(n){return e.handleMouseDown(n)});u.add(this.dom.o,"click",function(n){return e.handleClick(n)});u.add(document,"mousemove",this.handleMouse.bind(this));u.add(document,"mouseup",this.releaseMouse.bind(this));u.add(this.dom.progressTrack,"mousedown",function(n){return s.isRightClick(n)?!0:(e.isGrabbing=!0,i.addClass(e.dom.o,"grabbing"),e.handleMouse(n))});window.navigator.userAgent.match(/mobile/i)||i.hasClass(this.dom.o,"auto-play")&&window.setTimeout(function(){e.playlistController.playItemByOffset(0)},2);i.hasClass(this.dom.o,"repeat-playback")&&window.setTimeout(function(){e.playlistController.data.loopMode=!0;i.toggleClass(r.get(e.dom.o,".sm2-icon-repeat").parentNode,e.css.active)},2)}return s.prototype.resetLyrics=function(){this.timeMarks=[];this.prevHighlightLnIndex=-1;this.lastDurationSet=-1;this.isLyricsReady=!1;this.currentLyricHeight=0;this.dom.lyricsContainer&&(this.dom.lyricsContainer.innerHTML="",this.dom.lyricsContainer.scrollTop=0);i.addClass(this.dom.lyricsDrawer,this.css.lyricHidden);i.addClass(this.dom.lyricsContainer,this.css.lyricContainerHidden);i.addClass(this.dom.lyricsWrapper,this.css.lyricContainerHidden)},s.prototype.stopOtherSounds=function(){this.playerOptions.stopOtherSounds&&soundManager.stopAll()},s.prototype.loadLyrics=function(t){var i=t.getAttribute(n.Options.FileSrcAttribute),r=t.getAttribute(n.Options.FileLyricAttribute),f=parseInt(t.getAttribute(n.Options.FileLyricOffsetAttribute)),u=t.getAttribute(n.Options.FileLyricIgnoreMetadataAttribute),e=(u?u:"").toLowerCase()==="true";soundManager.canPlayURL(i)&&(this.resetLyrics(),r&&this.loadAndPresentLyrics(i,r,f,e))},s.prototype.playLink=function(t){var i=t.getAttribute(n.Options.FileSrcAttribute);soundManager.canPlayURL(i)&&(this.playlistController.data.timer&&(window.clearTimeout(this.playlistController.data.timer),this.playlistController.data.timer=null),this.soundObject||(this.soundObject=this.makeSound(i)),this.soundObject.stop(),this.playlistController.select(t.parentNode),this.setTitle(t.parentNode),this.dom.progress.style.left="0px",this.dom.progressBar.style.width="0px",this.stopOtherSounds(),this.soundObject.play({url:i,position:0}),this.currentFileUrl=i,this.loadLyrics(t))},s.prototype.loadAndPresentLyrics=function(t,r,u,f){function c(t,i,r){return new Promise(function(u){var f=new XMLHttpRequest;f.open("GET",i,!0);f.onload=function(){var i=f.responseText,r=Light.Lyrics.LrcParser.parse(i);u(new n.Lyrics.LrcResult(r!=null,t,i,r))};f.onerror=function(){r&&console.warn(f.statusText);u(new n.Lyrics.LrcResult(!1,t,null))};f.send(null)})}function s(n){return String(n).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function l(n,t){if(!n)throw new e("title");if(!t)throw new e("artist");var i="<b>"+s(t)+"<\/b> - "+s(n);o.dom.playlistTarget.innerHTML='<ul class="sm2-playlist-bd"><li>'+i+"<\/li><\/ul>";o.dom.playlistTarget.getElementsByTagName("li")[0].scrollWidth>o.dom.playlistTarget.offsetWidth&&(o.dom.playlistTarget.innerHTML='<ul class="sm2-playlist-bd"><li><marquee>'+i+"<\/marquee><\/li><\/ul>")}function a(){return __awaiter(this,void 0,void 0,function(){var n,i,h,a,e;return __generator(this,function(v){switch(v.label){case 0:return[4,c(t,r,!0)];case 1:if(n=v.sent(),n.isRequestSucceeded&&n.requestId==o.currentFileUrl){for(n.content.title&&n.content.artist&&!f&&l(n.content.title,n.content.artist),i=void 0,h=n.content.sentences,a=[],i=0;i<h.length;i++)e=h[i],o.timeMarks.push(e.time+u),a.push('<li data-time="'+(e.time+u)+'" class="lyric-content">'+s(e.content)+"<\/li>");o.dom.lyricsContainer.innerHTML=a.join("")}return[2]}})})}var h=this,o;u||(u=0);o=this;a().then(function(){o.isLyricsReady=!0;i.removeClass(o.dom.lyricsDrawer,o.css.lyricHidden);i.removeClass(o.dom.lyricsWrapper,o.css.lyricContainerHidden);i.removeClass(h.dom.lyricsContainer,h.css.lyricContainerHidden)})},s.prototype.makeSound=function(t){var f=this,u=this;return soundManager.createSound({url:t,volume:this.defaultVolume,whileplaying:function(){var f=100,e,o,t,r;if(e=Math.min(f,Math.max(0,f*(this.position/this.durationEstimate)))+"%",o=Math.min(100,Math.max(0,100*this.position/this.durationEstimate))+"%",this.duration&&(u.dom.progress.style.left=e,u.dom.progressBar.style.width=o,u.dom.time.innerHTML=n.Player.Sm2Player.getTime(this.position,!0)),u.isLyricsReady){for(t=void 0,t=0;t<u.timeMarks.length;t++)if(u.timeMarks[t]>this.position)break;t>0&&t--;u.timeMarks[t]!=u.lastDurationSet&&(u.prevHighlightLnIndex>=0&&u.dom.lyricsContainer.children[u.prevHighlightLnIndex]&&i.toggleClass(u.dom.lyricsContainer.children[u.prevHighlightLnIndex],u.css.lyricHighlight),u.dom.lyricsContainer.children[t]&&i.toggleClass(u.dom.lyricsContainer.children[t],u.css.lyricHighlight),u.prevHighlightLnIndex>=0&&(r=u.dom.lyricsContainer.children[u.prevHighlightLnIndex],r&&(u.currentLyricHeight=r.offsetTop-r.offsetHeight/2)),u.dom.lyricsContainer&&Math.abs(u.currentLyricHeight-u.dom.lyricsContainer.scrollTop)>=42&&(window.jQuery?$(u.dom.lyricsContainer).clearQueue().animate({scrollTop:u.currentLyricHeight},370):u.dom.lyricsContainer.scrollTop=u.currentLyricHeight),u.prevHighlightLnIndex=t,u.lastDurationSet=u.timeMarks[t])}},whileloading:function(){this.isHTML5||(u.dom.duration.innerHTML=n.Player.Sm2Player.getTime(this.durationEstimate,!0))},onbufferchange:function(n){(n?i.addClass:i.removeClass)(f.dom.o,"buffering")},onplay:function(){i.swapClass(f.dom.o,"paused","playing");f.callback("play")},onpause:function(){i.swapClass(f.dom.o,"playing","paused");f.callback("pause")},onresume:function(){i.swapClass(f.dom.o,"paused","playing")},onload:function(t){t?(u.dom.duration.innerHTML=n.Player.Sm2Player.getTime(this.duration,!0),u.failureCount=0):this._iO&&this._iO.onerror&&this._iO.onerror()},onerror:function(){f.failureCount++;f.failureCount>=f.failureThreshold&&f.playlistController.data.loopMode&&(f.playlistController.data.loopMode=!1,i.toggleClass(r.get(f.dom.o,".sm2-icon-repeat").parentNode,f.css.active));var u,n,t;u=f.playlistController.getItem();u&&f.extras.loadFailedCharacter&&(f.dom.playlistTarget.innerHTML=f.dom.playlistTarget.innerHTML.replace("<li>","<li>"+f.extras.loadFailedCharacter+" "),f.playlistController.data.playlist&&f.playlistController.data.playlist[f.playlistController.data.selectedIndex]&&(n=f.playlistController.data.playlist[f.playlistController.data.selectedIndex].getElementsByTagName("a")[0],t=n.innerHTML,t.indexOf(f.extras.loadFailedCharacter)===-1&&(n.innerHTML=f.extras.loadFailedCharacter+" "+t)));f.callback("error");navigator.userAgent.match(/mobile/i)?f.actions.next():(f.playlistController.data.timer&&window.clearTimeout(f.playlistController.data.timer),f.playlistController.data.timer=window.setTimeout(f.actions.next,2e3))},onstop:function(){i.removeClass(f.dom.o,"playing")},onfinish:function(){var f,n,r,t;i.removeClass(u.dom.o,"playing");u.dom.progress.style.left="0%";f=u.playlistController.data.selectedIndex;u.callback("finish");u.resetLyrics.bind(u);n=u.playlistController.getNext();n&&u.playlistController.data.selectedIndex!==f||n&&u.playlistController.data.loopMode?(r=n.getElementsByTagName("a"),t=void 0,r.length&&(t=r[0]),t&&u.playLink(t)):u.callback("end")}})},s.prototype.setTitle=function(n){var t=n.getElementsByTagName("a");t.length&&(n=t[0]);this.dom.playlistTarget.innerHTML='<ul class="sm2-playlist-bd"><li>'+n.innerHTML.replace(this.extras.loadFailedCharacter,"")+"<\/li><\/ul>";this.dom.playlistTarget.getElementsByTagName("li")[0].scrollWidth>this.dom.playlistTarget.offsetWidth&&(this.dom.playlistTarget.innerHTML='<ul class="sm2-playlist-bd"><li><marquee>'+n.innerHTML+"<\/marquee><\/li><\/ul>")},s.getTime=function(n,t){var f=Math.floor(n/1e3),i=Math.floor(f/3600),r=Math.floor(f/60)-Math.floor(i*60),u=Math.floor(f-i*3600-r*60);return t?(i?i+":":"")+(i&&r<10?"0"+r:r)+":"+(u<10?"0"+u:u):{min:r,sec:u}},s.prototype.callback=function(n){n&&this.on&&this.on[n]&&this.on[n](this)},s.isRightClick=function(n){if(n&&(n.which&&n.which===2||n.which===undefined&&n.button!==1))return!0},s.prototype.getActionData=function(n){if(!n)return!1;this.actionData.volume.x=f.getOffX(n);this.actionData.volume.y=f.getOffY(n);this.actionData.volume.width=n.offsetWidth;this.actionData.volume.height=n.offsetHeight;this.actionData.volume.backgroundSize=parseInt(o.get(n,"background-size"),10);window.navigator.userAgent.match(/msie|trident/i)&&(this.actionData.volume.backgroundSize=this.actionData.volume.backgroundSize/this.actionData.volume.width*100)},s.prototype.handleMouse=function(n){if(this.isGrabbing){var r=void 0,u=void 0,e=void 0,o=void 0,i=void 0,t=void 0;r=this.dom.progressTrack;u=f.getOffX(r);e=r.offsetWidth;o=n.clientX-u;i=o/e;i>=1&&(i=1);t=this.soundObject;t&&t.duration&&(t.setPosition(t.duration*i),t._iO&&t._iO.whileplaying&&t._iO.whileplaying.apply(t));n.preventDefault&&n.preventDefault()}return!1},s.prototype.handleMouseDown=function(n){var r,t;return(t=n.target||n.srcElement,s.isRightClick(n))?!0:(t.nodeName.toLowerCase()!=="a"&&(r=t.getElementsByTagName("a"),r&&r.length&&(t=t.getElementsByTagName("a")[0])),i.hasClass(t,"sm2-volume-control")?(this.getActionData(t),u.add(document,"mousemove",this.actions.adjustVolume.bind(this)),u.add(document,"mouseup",this.actions.releaseVolume.bind(this)),this.actions.adjustVolume(n)):void 0)},s.prototype.releaseMouse=function(n){return this.isGrabbing=!1,i.removeClass(this.dom.o,"grabbing"),u.preventDefault(n),!1},s.prototype.handleClick=function(t){var e,r,s,f,h,o,c;if(e=t||window.event,r=e.target||e.srcElement,r&&r.nodeName){if(f=r.nodeName.toLowerCase(),f!=="a"&&r.parentNode){do r=r.parentNode,f=r.nodeName.toLowerCase();while(f!=="a"&&r.parentNode);if(!r)return!1}if(f==="a"){if(h=r.getAttribute(n.Options.FileSrcAttribute),soundManager.canPlayURL(h))i.hasClass(r,this.playerOptions.excludeClass)||(this.playLink(r),o=!0);else if(s=r.href.lastIndexOf("#"),s!==-1){o=!0;c=r.href.substr(s+1);switch(c){case"play":this.actions.play(t);break;case"pause":this.actions.pause();break;case"prev":this.actions.prev();break;case"next":this.actions.next();break;case"repeat":this.actions.repeat(t);break;case"menu":this.actions.menu(t);break;default:o=!1}}if(o)return u.preventDefault(e)}}},s}();t.Sm2Player=s})(t=n.Player||(n.Player={}))}(Sm2Shim||(Sm2Shim={})),function(n){var t;(function(t){var i=Sm2ShimUtils.DomUtils,r=Sm2ShimUtils.CssUtils,u=function(){function t(n,t,i){this.data={playlist:null,selectedIndex:0,loopMode:!1,timer:null};this.player=n;this.dom=t;this.css=i;this.defaultVolume=soundManager.defaultOptions.volume;this.initDOM();this.refreshDOM();Sm2ShimUtils.CssUtils.hasClass(this.dom.o,this.css.playlistOpen)&&window.setTimeout(function(){},1)}return t.prototype.getPlaylist=function(){return this.data.playlist},t.prototype.getItem=function(n){var t;return this.data.selectedIndex===null?n:(t=this.getPlaylist(),n=n!==undefined?n:this.data.selectedIndex,n=Math.max(0,Math.min(n,t.length)),t[n])},t.prototype.getNext=function(){return this.data.selectedIndex!==null&&this.data.selectedIndex++,this.data.playlist.length>1?this.data.selectedIndex>=this.data.playlist.length&&(this.data.loopMode?this.data.selectedIndex=0:this.data.selectedIndex--):this.data.selectedIndex=this.data.loopMode?0:null,this.getItem()},t.prototype.getPrevious=function(){return this.data.selectedIndex--,this.data.selectedIndex<0&&(this.data.loopMode?this.data.selectedIndex=this.data.playlist.length-1:this.data.selectedIndex++),this.getItem()},t.prototype.getURL=function(){var t,i;return t=this.getItem(),t&&(i=t.getElementsByTagName("a")[0].getAttribute(n.Options.FileSrcAttribute)),i},t.prototype.playItemByOffset=function(n){n=n||0;var t=this.getItem(n);t&&this.player.playLink(t.getElementsByTagName("a")[0])},t.prototype.select=function(n){var h,t,u,f,e,o,s;this.resetLastSelected();n&&(s=i.ancestor("li",n),r.addClass(s,this.css.selected),t=n.offsetTop,u=t+n.offsetHeight,f=this.dom.playlistContainer.offsetHeight,e=this.dom.playlist.scrollTop,o=8,u>f+e?this.dom.playlist.scrollTop=u-f+o:t<e&&(this.dom.playlist.scrollTop=n.offsetTop-o));h=this.findOffsetFromItem(s);this.data.selectedIndex=h},t.prototype.refresh=function(){return this.refreshDOM()},t.prototype.findOffsetFromItem=function(n){var i,t,u,r;if(r=-1,i=this.getPlaylist(),i)for(t=0,u=i.length;t<u;t++)if(i[t]===n){r=t;break}return r},t.prototype.resetLastSelected=function(){for(var u=i.getAll(this.dom.playlist,"."+this.css.selected),n=0,t=u.length;n<t;n++)r.removeClass(u[n],this.css.selected)},t.prototype.initDOM=function(){this.dom.playlistTarget=i.get(this.dom.o,".sm2-playlist-target");this.dom.playlistContainer=i.get(this.dom.o,".sm2-playlist-drawer");this.dom.playlist=i.get(this.dom.o,".sm2-playlist-bd")},t.prototype.refreshDOM=function(){if(!this.dom.playlist)return window.console&&console.warn&&console.warn("refreshDOM(): playlist node not found?"),!1;this.data.playlist=this.dom.playlist.getElementsByTagName("li")},t}();t.Sm2PlaylistController=u})(t=n.Player||(n.Player={}))}(Sm2Shim||(Sm2Shim={}));Sm2Player=Sm2Shim.Player.Sm2Player;domUtils=Sm2ShimUtils.DomUtils,function(){if(!window.SM2BarPlayer){var i=".sm2-bar-ui",t=[],n=200;window.navigator.userAgent.match(/mobile/i)&&(n=500);soundManager.setup({html5PollingInterval:n,flashPollingInterval:n,flashVersion:9,debugMode:!1,debugFlash:!1,preferFlash:!1,url:"https://mmixstaticassets.azureedge.net/Sm2Shim/"});soundManager.onready(function(){var n,u,r=domUtils.getAll(i);if(r&&r.length)for(n=0,u=r.length;n<u;n++)t.push(new Sm2Player(r[n]))});window.sm2BarPlayers=t;window.SM2BarPlayer=Sm2Player}}();